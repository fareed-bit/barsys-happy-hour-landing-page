...
// Collins: flat-fee interactive bartender. Deliberately a separate section rather than a fourth
// .cards tier - the tiers are per guest, Collins is per event, and a shared grid invites the wrong
// comparison. Markup lives here, not in site/packages.html, because that file is generated output.
const COLLINS_SECTION='<section class="split collins-intro" id="collins"><div><h2>Collins</h2><p>A bartender your guests can talk to, held to the drinks you are actually pouring. Priced as a flat fee per event, not per guest &mdash; iPads, stands, our team on site, your menu and your branding are included, not add-ons. Larger rooms get more stations, not a higher rate per head.</p></div></section><section class="split"><div><h2>Add Collins</h2><p class="price">$950<small> flat, per event</small></p><p>A bartender your guests can talk to, that knows your menu and will not go off it. Name the drinks you are pouring and Collins recommends those and nothing else &mdash; no off-menu suggestions, no drink you did not agree to.</p><p>Up to 75 guests. $1,450 to 150, $1,950 to 250 &mdash; the step up is stations and staff, not a per-head rate.</p><p>Added to Classic or Signature. Included with Reserve at every size.</p><a href="/site/collins.html">Explore <span aria-hidden="true">&#8599;</span></a></div><div><h2>Collins on your bar</h2><p class="price">$2,250<small> flat, per event</small></p><p>You already have the bar. We bring the experience to it &mdash; iPads, our team, your drinks list, your branding &mdash; for venues and offices that pour their own.</p><p>Up to 75 guests. $3,250 to 150, $4,500 to 250. Two-hour baseline, same as every package.</p><a href="/site/collins.html">Explore <span aria-hidden="true">&#8599;</span></a></div></section>';
