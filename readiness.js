...
(() => {
 ...
 function glasswareMarkup(s,prefix='detail'){
   ...
   return `<section class="scope-panel"><p class="eyebrow">SERVICE SCOPE / NOT A HIDDEN EXTRA</p>${select(s,prefix,'glassware','Glassware',maps.glassware,inc?'Included with your package.':'Confirmed in your proposal \u2014 no sample-event charge.')}<p class="readiness-small">Delivery, load-in and venue access are required scope, outside this subtotal.</p></section>`;
 }
